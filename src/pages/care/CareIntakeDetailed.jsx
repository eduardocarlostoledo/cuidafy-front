...
const NEED_TYPE_TO_PRESET = {
  guardia_247: "cuidado_247",
  higiene_movilidad: "higiene_personal",
  acompanamiento_integral: "acompanamiento_hogar",
};

const CareIntakeDetailed = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const presetId = NEED_TYPE_TO_PRESET[form.needType];
    ...
    if (form.shift) params.set("shift", form.shift);
    if (form.frequency) params.set("frequency", form.frequency);
    if (form.preferredSpecialty) params.set("especialidad", form.preferredSpecialty);
      ...
      <div className={cardClassName}>
        ...
        <div className="mt-5 space-y-4 text-sm text-slate-600">
          ...
          <div>
            ...
            <p>Al guardar volvemos a los resultados con estos filtros aplicados.</p>
          </div>
        </div>
      </div>
  ...
  return (
    <CareFlowFrame
      currentStep="intake"
      title="Ajusta tu pedido con filtros finos"
      description="Usa esta ficha cuando necesites mayor precision: tipo de cuidado, contexto clinico, preferencias de pago y contacto. Al guardar, volvemos al listado con los filtros aplicados."
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          >
            {loading
              ...
              : mode === "long"
              ? "Aplicar filtros y ver matching"
...
export default CareIntakeDetailed;
