                ...
                <div className="grid gap-10 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex items-center justify-between mb-4">
                            <h5 className="text-xl font-medium leading-none mb-2">Ultimos favoritos registrados</h5>
                        </div>
                            ...
                            <div className="flex flex-wrap -mx-4">
                                    ...
                                    <a href="" className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                        <div className="p-4">
                                            <div className='flex justify-between items-center w-full'>
                                                <p className="inline-block px-2 py-1 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-xs">Depilación</p>
                                                <AiFillHeart className='w-6 h-6 text-primary' />
                                            </div>

                                            <h2 className="mt-2 mb-2  font-bold">Depilación con cera hombre suscripción 6 meses.</h2>

                                            <div className="mt-3 flex items-center">
                                                <span className="text-sm font-semibold">$</span> <span className="text-sm font-semibold line-through">1.449.000</span>&nbsp;<span className="text-sm font-semibold">$</span><span className="font-bold text-xl">509.000</span>&nbsp;
                                            </div>
                                        </div>
                                ...
                                <div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                                    <a href="" className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                        <div className="p-4">
                                            <div className='flex justify-between items-center w-full'>
                                                <p className="inline-block px-2 py-1 leading-none bg-blue-200 text-blue-800 rounded-full font-semibold uppercase tracking-wide text-xs">Depilación</p>
                                                <AiFillHeart className='w-6 h-6 text-primary' />
                                            </div>
